    ...
    class Menucard {
        ...
        render() {
            ...
            <div class="menu__item-price">
                <div class="menu__item-const">Цена:</div>
...
new Menucard(
    ...
    "post",
    'Меню "Постное"',
    'Меню "Постное" - это тщательно подбор ингредиентов: полное отсутствие продуктов животного происхождения,'+
...
new Menucard(
    ...
    ' Красная рыба, морепродукты, фрукты - ресторанное меню бещ похода в ресторан!',
    21,
    ".menu .container"
).render();
